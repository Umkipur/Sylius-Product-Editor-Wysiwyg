...
namespace Tests\Umkipur\SyliusProductEditorWysiwyg\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Umkipur\SyliusProductEditorWysiwyg\Behat\Page\Shop\WelcomePageInterface;
